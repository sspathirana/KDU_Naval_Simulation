...
void setupSerComm(){
    ...
    neo[294] = 'R';neo[315] = 'R';neo[173] = 'R';neo[168] = 'R';neo[167] = 'R';neo[166] = 'R';neo[165] = 'R';neo[164] = 'R';neo[184] = 'R';
    ...
    neo[192] = 'R';neo[205] = 'R';neo[203] = 'R';neo[284] = 'R';neo[265] = 'R';neo[266] = 'R';neo[267] = 'R';neo[1] = 'R'; neo[295] = 'G'; neo[36] = 'R';neo[35] = 'R';neo[38] = 'R';
    neo[37] = 'R';neo[384] = 'R';neo[385] = 'R';neo[45] = 'R';neo[53] = 'R';neo[104] = 'R';neo[106] = 'R';neo[395] = 'R';neo[396] = 'R';neo[394] = 'R';neo[393] = 'R';
}
int actEng=0;
;
void send_actuator(){
    ...
    if(speed_value>20 && actEng ==0){actEng=4; engineStart(); neo[138] = 'G'; Serial2.println("STAR2"); }
    else if(actEng == 4 && speed_value < 10) {actEng=0; playerStop(); neo[138] = 'd'; delay(300);Serial2.println("STO2");delay(200);}

}
int lube_en=0, LO_aft_trans1_en=0, LO_aft_trans2_en=0;
void Lube(){
    if(neo[341] == 'G' && lube_en==0){Serial2.println("STAT22"); lube_en=4;}
    if(neo[264] == 'G' && LO_aft_trans1_en==0){Serial2.println("STAR3");LO_aft_trans1_en=4;}
    else if(neo[264]='R' && LO_aft_trans1_en==4){Serial2.println("STO3");LO_aft_trans1_en=0;}
    if(neo[263] == 'G' && LO_aft_trans2_en==0){Serial2.println("STAR4");LO_aft_trans2_en=4;}
    else if(neo[263]='R' && LO_aft_trans2_en==4){Serial2.println("STO4");LO_aft_trans2_en=0;}
...
void readSerial(){
    ...
    while (Serial1.available()){
        ...
        if(Serial1.available()>0){
               ...
               if (readString.length() > 3) 
            {
                ...
                if(key[0]== '1')if(key[1]== '6')if(key[2]== '7'){neo[146] = 'G';neo[1] = 'G';hotWell = 4;tankTime = millis();} if(key[0]== '5')if(key[1]== '6')if(key[2]== '7'){neo[146] = 'R';neo[1] = 'R';} 
                if(key[0]== '1')if(key[1]== '6')if(key[2]== '4'){neo[181] = 'G';neo[396] = 'G';} if(key[0]== '5')if(key[1]== '6')if(key[2]== '4'){neo[181] = 'R';neo[396] = 'R';} 
                if(key[0]== '1')if(key[1]== '9')if(key[2]== '8'){neo[148] = 'B';neo[394] = 'B';} if(key[0]== '1')if(key[1]== '9')if(key[2]== '9'){neo[148] = 'G';neo[394] = 'G';} if(key[0]== '5')if(key[1]== '9')if(key[2]== '9'){neo[148] = 'R';neo[394] = 'R';} 
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '1'){if(neo[103]=='R' && neo[105]=='R') player.volume(25);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '2'){if(neo[103]=='R' && neo[105]=='R')player.volume(22);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '3'){if(neo[103]=='R' && neo[105]=='R')player.volume(15);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== 'O'){if(neo[103]=='R' && neo[105]=='R')playerStop();}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '1'){if(neo[102]=='R' || neo[109]=='R' || neo[123]=='R') player.volume(25);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '2'){if(neo[102]=='R' ||neo[109]=='R' || neo[123]=='R')player.volume(22);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '3'){if(neo[102]=='R' || neo[109]=='R' || neo[123]=='R')player.volume(15);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== 'O'){if(neo[102]=='R' || neo[109]=='R' || neo[123]=='R')playerStop();}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '1'){if(neo[107]=='R' || neo[108]=='R' || neo[123]=='R') player.volume(25);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '2'){if(neo[107]=='R' ||neo[108]=='R' || neo[123]=='R')player.volume(22);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '3'){if(neo[107]=='R' || neo[108]=='R' || neo[123]=='R')player.volume(15);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== 'O'){if(neo[107]=='R' || neo[108]=='R' || neo[123]=='R')playerStop();}
                readString = "";
            }
        }
    }
        ...
        if(Serial2.available()>0){
           ...
           // Serial.print(esp2);
               ...
               if (readString.length() > 3) 
            {
                ...
                if(key[0]== '1')if(key[1]== '8')if(key[2]== '8'){neo[262] = 'G';neo[348] = 'G';COserTank = 4;tankTime = millis();} if(key[0]== '5')if(key[1]== '8')if(key[2]== '8'){neo[262] = 'R';neo[348] = 'R';} 
                ...
                if(key[0]== 'A')if(key[1]== 'L')if(key[2]== 'M'){alarm_on=4;}
                readString = "";
            }
        }
    }
    while (Serial3.available()){
        ...
        // }
            if (readString.length() > 3) 
            {
                ...
                if(key[0]== '1')if(key[1]== '3')if(key[2]== '8'){neo[289] = 'G';neo[53] = 'G';} if(key[0]== '5')if(key[1]== '3')if(key[2]== '8'){neo[289] = 'R';neo[53] = 'R';} 
                ...
                if(key[0]== '1')if(key[1]== '4')if(key[2]== '2'){neo[286] = 'G';neo[35] = 'G';} if(key[0]== '1')if(key[1]== '4')if(key[2]== '1'){neo[286] = 'B';neo[35] = 'B';} if(key[0]== '5')if(key[1]== '4')if(key[2]== '1'){neo[286] = 'R';neo[35] = 'R';}
                if(key[0]== '1')if(key[1]== '3')if(key[2]== '5'){neo[291] = 'G';neo[384] = 'G';} if(key[0]== '1')if(key[1]== '3')if(key[2]== '4'){neo[291] = 'B';neo[384] = 'B';} if(key[0]== '5')if(key[1]== '3')if(key[2]== '4'){neo[291] = 'R';neo[384] = 'R';}
                ...
                if(key[0]== '1')if(key[1]== '4')if(key[2]== '4'){neo[285] = 'G';neo[36] = 'G';} if(key[0]== '1')if(key[1]== '4')if(key[2]== '3'){neo[285] = 'B';neo[36] = 'B';} if(key[0]== '5')if(key[1]== '4')if(key[2]== '3'){neo[285] = 'R';neo[36] = 'R';}
                ...
                if(key[0]== '1')if(key[1]== '5')if(key[2]== '2'){neo[143] = 'G';neo[106] = 'G';} if(key[0]== '1')if(key[1]== '5')if(key[2]== '1'){neo[143] = 'B';neo[106] = 'B';} if(key[0]== '5')if(key[1]== '5')if(key[2]== '1'){neo[143] = 'R';neo[106] = 'R';}
                if(key[0]== '1')if(key[1]== '4')if(key[2]== '8'){neo[144] = 'B';neo[104] = 'B';} if(key[0]== '1')if(key[1]== '4')if(key[2]== '7'){neo[144] = 'G';neo[104] = 'G';} if(key[0]== '5')if(key[1]== '4')if(key[2]== '7'){neo[144] = 'R';neo[104] = 'R';}
                if(key[0]== '2')if(key[1]== '0')if(key[2]== '1'){neo[147] = 'G';neo[393] = 'G';} if(key[0]== '2')if(key[1]== '0')if(key[2]== '0'){neo[147] = 'B';neo[393] = 'B';} if(key[0]== '6')if(key[1]== '0')if(key[2]== '0'){neo[147] = 'R';neo[393] = 'R';}
    ...
    if((neo[265]=='G'|| neo[266]=='G') && neo[281]=='R')synchronize(); 
    else if(neo[265]=='G' && neo[281]=='G')DG1synced();
    else if(neo[281]=='G' && neo[266]=='G' && syncVar2 != 4)synchronize();
    else if(neo[281]=='G' && neo[266]=='G' && syncVar2 == 4)DG1synced();
    else stopSync();
}
