...
int mainSwitch=0;
void mainScan(){
    if(digitalRead(in1)==LOW ){if(countA[4]<1)Serial.println("1");countA[4]++;count_[4]=0;delay(20);mainSwitch=4;/* playerStop(); */}
    else if(digitalRead(in1)==HIGH && count_[4]<1){Serial.println("701");countA[4]=0;count_[4]++;delay(20);mainSwitch=8;}     
}
...
void scanToggle(){
    ...
    if(digitalRead(in139)==LOW ){if(countA[7]<1)Serial.println("139");countA[7]++;neo[288] = 'G';neo[45] = 'G';count_[7]=0;delay(20);}
    else if(digitalRead(in139)==HIGH && count_[7]<1){Serial.println("539");neo[288] = 'R';neo[45] = 'R';countA[7]=0;count_[7]++;delay(20);} 
