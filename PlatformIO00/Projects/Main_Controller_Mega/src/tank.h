...
void tank(){
    if(expansionTank==4 and neo[383] == 'G'){
        ...
        if(count[0]==2) neo[379]='G'; 
        if(count[0]==3) neo[380]='Y'; 
        if(count[0]==4) neo[381]='R'; 
        if(count[0]==5) {neo[382]='R'; alarm_on=4;count[0]=0;}
    }

    if(DOserTank==4 and neo[371] == 'G'){
    ...
    if(DOdeepTank==4 and neo[386] == 'G'){
     ...
     if(MEoilTank2==4 and neo[74] == 'G'){
        ...
        if(count[6]==4) {neo[86]='R'; alarm_on=4;count[6]=0;}
     }

     if(DGoilTank==4 and neo[87] == 'G'){
        if(millis()-tankTime>tankDelay){
            Serial.println("fill");
            tankTime=millis();
            count[7]++;
        ...
        if(count[7]==4) {neo[88]='R'; alarm_on=4;count[7]=0;}
     }

     if(MEoilTank1==4 and neo[97] == 'G'){
        if(millis()-tankTime>tankDelay){
            Serial.println("fill");
            tankTime=millis();
            count[8]++;
        ...
        if(count[8]==4) {neo[96]='R'; alarm_on=4;count[8]=0;}
     }

    if(FOsettlingT2==4 and neo[39] == 'G'){
        if(millis()-tankTime>tankDelay){
            Serial.println("fill");
            tankTime=millis();
            count[9]++;
    ...
    if(COtank==4 and neo[355] == 'G'){
        ...
        if(count[11]==6) {neo[354]='R'; alarm_on=4;count[11]=0;}
    }

    if(FOsettlingT1==4 and neo[34] == 'G'){
        if(millis()-tankTime>tankDelay){
            Serial.println("fill");
            tankTime=millis();
            count[12]++;
    ...
    if(HFOcenterTank==4 and neo[51] == 'G'){
        if(millis()-tankTime>tankDelay){
            Serial.println("fill");
            tankTime=millis();
            count[14]++;
    ...
    if(HFOstbdTank==4 and neo[66] == 'G'){
        ...
        if(count[15]==1) neo[70]='G';
        if(count[15]==2) neo[69]='G'; 
        if(count[15]==3) neo[68]='Y'; 
        if(count[15]==4) {neo[67]='R'; alarm_on=4;count[15]=0;}
    }
}
