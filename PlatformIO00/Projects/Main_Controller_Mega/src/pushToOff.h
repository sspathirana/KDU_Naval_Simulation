...
void scanPush() {
  ...
  if ((millis() - lastDebounceTime) > debounceDelay) {
    ...
    if (in108 != bttSt_a3) { bttSt_a3 = in108; if (bttSt_a3 == HIGH) {toggle[108] = !toggle[108]; neo[306] = (toggle[108] ? 'G' : 'R'); } }
    if (in110 != bttSt_a4) { bttSt_a4 = in110; if (bttSt_a4 == HIGH) {toggle[110] = !toggle[110]; neo[308] = (toggle[110] ? 'G' : 'R');} }
    if (in113 != bttSt_a5) { bttSt_a5 = in113; if (bttSt_a5 == HIGH) {toggle[113] = !toggle[113]; neo[311] = (toggle[113] ? 'R' : 'G');} }
    ...
    if (in112 != bttSt_io22) { bttSt_io22 = in112; if (bttSt_io22 == HIGH) {toggle[112] = !toggle[112]; neo[310] = (toggle[112] ? 'R' : 'G');} }
    if (in111 != bttSt_io23) { bttSt_io23 = in111; if (bttSt_io23 == HIGH) {toggle[111] = !toggle[111]; neo[309] = (toggle[111] ? 'R' : 'G');} }
    if (in119 != bttSt_io24) { bttSt_io24 = in119; if (bttSt_io24 == HIGH) {toggle[119] = !toggle[119]; neo[318] = (toggle[119] ? 'R' : 'G');} }
    if (in109 != bttSt_io25) { bttSt_io25 = in109; if (bttSt_io25 == HIGH) {toggle[109] = !toggle[109]; neo[307] = (toggle[109] ? 'G' : 'R');} }
    ...
    if (in106 != bttSt_io30) { bttSt_io30 = in106; if (bttSt_io30 == HIGH) {toggle[106] = !toggle[106]; neo[304] = (toggle[106] ? 'G' : 'R');} }
    if (in105 != bttSt_io31) { bttSt_io31 =in105; if (bttSt_io31 == HIGH) {toggle[105] = !toggle[105]; neo[303] = (toggle[105] ? 'G' : 'R');} }
    if (in117 != bttSt_io32) { bttSt_io32 = in117; if (bttSt_io32 == HIGH) {toggle[117] = !toggle[117]; neo[296] = (toggle[117] ? 'R' : 'G');} }
    if (in107 != bttSt_io33) { bttSt_io33 = in107; if (bttSt_io33 == HIGH) {toggle[107] = !toggle[107]; neo[305] = (toggle[107] ? 'G' : 'R');} }
  }
