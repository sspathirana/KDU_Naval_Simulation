...
void displayDG1_on(){
  ...
  if(DG1<1460 && display_[0]==4) DG1=DG1+50;
  else if(DG1>0 && display_[0]==8){DG1=DG1-50; if(DG1<100)Serial.println("STOP"); else if(DG1<300)Serial.println("ST3P"); else if(DG1<600)Serial.println("ST2P"); else if(DG1<800)Serial.println("ST1P");} 
  display.println(DG1);
  display.display(); 
...
void displayDG2_on(){
  ...
  if(DG2<1460 && display_[1]==4) DG2=DG2+50;
  else if(DG2>0 && display_[1]==8){DG2=DG2-50; if(DG2<100)Serial.println("STOP"); else if(DG2<300)Serial.println("ST3P"); else if(DG2<600)Serial.println("ST2P"); else if(DG2<800)Serial.println("ST1P");} 
  display.println(DG2);
  display.display(); 
