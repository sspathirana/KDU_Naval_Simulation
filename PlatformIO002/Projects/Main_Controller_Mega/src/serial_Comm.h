...
void setupSerComm(){
    ...
    neo[37] = 'R';neo[384] = 'R';neo[385] = 'R';neo[45] = 'R';neo[53] = 'R';neo[104] = 'R';neo[106] = 'R';
}
void send_actuator(){
    ...
    while (Serial1.available()){
        ...
        if(Serial1.available()>0){
               ...
               if (readString.length() > 3) 
            {
                ...
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '1'){player.volume(25);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '2'){player.volume(22);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== '3'){player.volume(15);}
                if(key[0]== 'S')if(key[1]== 'T')if(key[2]== 'O'){playerStop();}
                readString = "";
            }
        }
    }
