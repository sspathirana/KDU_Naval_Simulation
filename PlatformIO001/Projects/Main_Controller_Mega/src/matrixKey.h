...
void serchMatrix(){
  ...
  if (customKey){
    ...
    if(neo[103]=='G' && engine_ST==0){engine_ST=1; Serial1.println("START"); engineStart();}
    ...
    if(neo[105]=='G' && engine_ST2==0){engine_ST2=1; Serial1.println("STAR2"); engineStart();}
